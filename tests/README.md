...
Logs for those functional tests can be found here: [Short](https://badges.oss.oxl.app/log/collection_fyrastack.opnsense_test_short.log), [Full](https://badges.oss.oxl.app/log/collection_fyrastack.opnsense_test.log)
