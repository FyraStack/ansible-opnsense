...
from ansible_collections.fyrastack.opnsense.plugins.module_utils.test.mock_pytest import \
...
from ansible_collections.fyrastack.opnsense.plugins.module_utils.test.util_pytest import log_test
from ansible_collections.fyrastack.opnsense.plugins.module_utils.test.testdata.base_testdata import GenericTestdata
...
def test_multi_module_base(mocker):
    ...
    from ansible_collections.fyrastack.opnsense.plugins.module_utils.base.multi import build_multi_mod_args, \
        MultiModule
