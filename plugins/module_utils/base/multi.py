...
from ansible_collections.fyrastack.opnsense.plugins.module_utils.base.handler import ModuleSoftError
from ansible_collections.fyrastack.opnsense.plugins.module_utils.helper.main import diff_remove_empty
