...
from ansible_collections.fyrastack.opnsense.plugins.module_utils.test.testdata.base_testdata import \
...
def test_requests(mocker):
    ...
    from ansible_collections.fyrastack.opnsense.plugins.module_utils.base.api import Session, single_get, single_post
