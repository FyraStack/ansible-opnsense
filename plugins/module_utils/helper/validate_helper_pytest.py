...
def test_is_valid_mac_address(value, result):
    from ansible_collections.fyrastack.opnsense.plugins.module_utils.helper.validate import \
...
def test_is_valid_network(value, result):
    from ansible_collections.fyrastack.opnsense.plugins.module_utils.helper.validate import is_valid_network
...
def test_is_valid_host(value, result):
    from ansible_collections.fyrastack.opnsense.plugins.module_utils.helper.validate import is_valid_host
...
def test_validate_port(value, valid):
    from ansible_collections.fyrastack.opnsense.plugins.module_utils.helper.validate import validate_port
...
def test_validate_port_or_range(value, valid, params):
    from ansible_collections.fyrastack.opnsense.plugins.module_utils.helper.validate import validate_port_or_range
