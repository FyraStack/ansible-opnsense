...
try:
    ...
    from ansible_collections.fyrastack.opnsense.plugins.module_utils.defaults.rule import \
    ...
    from ansible_collections.fyrastack.opnsense.plugins.module_utils.main.nat_one_to_one import OneToOne
