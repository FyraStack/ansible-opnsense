...
try:
    ...
    from ansible_collections.fyrastack.opnsense.plugins.module_utils.defaults.openvpn import \
        OPENVPN_INSTANCE_MOD_ARGS
    from ansible_collections.fyrastack.opnsense.plugins.module_utils.main.openvpn_server import Server
