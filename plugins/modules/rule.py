...
try:
    ...
    from ansible_collections.fyrastack.opnsense.plugins.module_utils.defaults.rule import RULE_MOD_ARGS
    from ansible_collections.fyrastack.opnsense.plugins.module_utils.main.rule import Rule
