...
try:
    from ansible_collections.fyrastack.opnsense.plugins.module_utils.helper.utils import profiler
    from ansible_collections.fyrastack.opnsense.plugins.module_utils.main.package_main import process
